...
class _SavingInputScreenState extends State<SavingInputScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final bool isInvestment =
        _selectedCategoryName == '투자' || _selectedCategoryName == '주식';
    ...
    return Scaffold(
      ...
      body: _isLoadingCategories
          ? const Center(
              child: CircularProgressIndicator(color: AppColors.utility),
            )
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(20),
                      border: Border.all(
                        color: const Color(0xFFBEEAE4),
                        width: 1.2,
                      ),
                      boxShadow: [
                        BoxShadow(
                          color: AppColors.saving.withValues(alpha: 0.08),
                          blurRadius: 16,
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(color: const Color(0xFFD4F0EC)),
                          ),
                          child: Row(
                  ...
                  _sectionCard(
                    child: Column(
                      ...
                      children: [
                        ...
                        if (_parentCategoryHint(_selectedParentCategory) !=
                            null)
                          Padding(
                          ...
                          children: [
                            Row(
                              children: [
                                ...
                                const SizedBox(width: 8),
                                Text(
                                  '기록일: ${_selectedDate.toLocal().toString().split(' ')[0]}',
                                  style: const TextStyle(
                                    fontSize: 14,
                                    fontWeight: FontWeight.w700,
                                    color: AppColors.ink,
                                      ...
                                      data: Theme.of(context).copyWith(
                                        ...
                                        textButtonTheme: TextButtonThemeData(
                                          style: TextButton.styleFrom(
                                            foregroundColor: AppColors.utility,
                                          ),
                                        ),
                                      ),
                                      child: child!,
